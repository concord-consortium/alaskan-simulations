...
export const outputData: TOutputData = {
  ...
  Low5: [ {month: "May",
            output:{algae: 15, nitrate: 27, turbidity: 15}},
          {month: "June",
            output:{algae: 18, nitrate: 25, turbidity: 18}},
          {month: "July",
            output:{algae: 18, nitrate: 23, turbidity: 18}},
          {month: "August",
            output:{algae: 18, nitrate: 22, turbidity: 18}},
          {month: "September",
            output:{algae: 15, nitrate: 22, turbidity: 15}},
        ],
  Low10: [ {month: "May",
              output:{algae: 15, nitrate: 27, turbidity: 15}},
            {month: "June",
  ...
  High5: [ {month: "May",
              output:{algae: 80, nitrate: 27, turbidity: 80}},
            {month: "June",
              output:{algae: 75, nitrate: 32, turbidity: 75}},
            {month: "July",
              output:{algae: 75, nitrate: 34, turbidity: 75}},
            {month: "August",
              output:{algae: 75, nitrate: 38, turbidity: 75}},
            {month: "September",
              output:{algae: 75, nitrate: 38, turbidity: 75}},
          ],
  High10: [ {month: "May",
