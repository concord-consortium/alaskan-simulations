...
export const getDroppableId = (e: DragEndEvent) => e.active.data?.current?.droppableId;
...
export const Draggable: React.FC<IProps> = (props) => {
  ...
  const { selectedDraggableId, onClick } = useClickToDragDraggable(idWithDroppable, droppableId);
